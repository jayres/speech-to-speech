...
class TextToSpeechService:
    ...
    def _patch_torch_load(self):
        ...
        # Store the original torch.load in a local variable
    ...
    def synthesize(self, text: str, audio_prompt_path: Optional[str] = None, exaggeration: float = 0.5, cfg_weight: float = 0.5):
        """
    ...
    def long_form_synthesize(self, text: str, audio_prompt_path: Optional[str] = None, exaggeration: float = 0.5, cfg_weight: float = 0.5):
        """
    ...
    def save_voice_sample(self, text: str, output_path: str, audio_prompt_path: Optional[str] = None):
        """
